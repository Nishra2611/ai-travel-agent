...
patch(
    "ai_travel_agent.tools.attraction_finder.AttractionFinderTool._find",
    side_effect=mock_overpass_find,
).start()
patch(
    "ai_travel_agent.tools.restaurant_finder.RestaurantFinderTool._find",
    side_effect=mock_overpass_find,
).start()
patch(
    "ai_travel_agent.tools.flight_search.FlightSearchTool._run",
    side_effect=mock_flights,
).start()
patch(
    "ai_travel_agent.tools.hotel_search.HotelSearchTool._run", side_effect=mock_hotels
).start()
patch(
    "ai_travel_agent.tools.weather_checker.WeatherCheckerTool._run",
...
patch(
    "ai_travel_agent.evaluation.judge._call_ollama", side_effect=mock_ollama_judge
).start()
patch(
    "ai_travel_agent.evaluation.judge._call_anthropic", side_effect=mock_ollama_judge
).start()

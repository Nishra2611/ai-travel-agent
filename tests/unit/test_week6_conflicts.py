...
class TestConflictDetection(unittest.TestCase):
    ...
    def test_overlapping_activities_detected(self):
        acts = [
            make_act("a1", "Museum", time(9), time(11)),
    ...
    def test_impossible_travel_detected(self):
        acts = [
            make_act("a1", "Museum", time(9), time(10)),
    ...
    def test_opening_hours_too_early(self):
        acts = [
            make_act("a1", "Museum", time(7), time(9), open_t=time(9), close_t=time(18))
        ]
    ...
    def test_opening_hours_too_late(self):
        acts = [
            make_act(
                "a1", "Museum", time(17), time(19), open_t=time(9), close_t=time(18)
            )
        ]
        self.assertEqual(len(self.detector._opening_hours(make_day(1, acts))), 1)
    ...
    def test_opening_hours_within_bounds_ok(self):
        acts = [
            make_act(
                "a1", "Museum", time(10), time(12), open_t=time(9), close_t=time(18)
            )
        ]
    ...
    def test_too_many_activities_detected(self):
        acts = [
            make_act(f"a{i}", f"Stop{i}", time(9 + i), time(9 + i, 45))
            for i in range(6)
        ]
    ...
    def test_resolver_fixes_overlap_end_to_end(self):
        ...
        park = next(
            a for d in fixed_itin.days for a in d.activities if a.attraction_id == "a2"
        )
